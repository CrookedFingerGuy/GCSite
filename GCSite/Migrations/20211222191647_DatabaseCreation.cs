        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Genre = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReleaseDateUs = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ReleaseDateJp = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ReleaseDateEu = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ThumbnailPath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CoverArtPath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ManualScanPath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThreeDBoxmodelPath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RetailPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    CurrentValueCib = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    CurrentValueMo = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    GameSizeMb = table.Column<long>(type: "bigint", nullable: true),
                    GamePlayLength = table.Column<long>(type: "bigint", nullable: true),
                    MinSpecs = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BoxStyle = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BoxSize = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MediaType = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MediaCount = table.Column<int>(type: "int", nullable: true),
                    MediaScanPath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastIP = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsCollectionPublic = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewInBox = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    HasManual = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    HasBox = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Condition = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GCUserId = table.Column<int>(type: "int", nullable: false),
